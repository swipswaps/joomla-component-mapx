CREATE TABLE IF NOT EXISTS `#__xmap_sitemap` (
  ...
  `count_xml`        INT(11)          UNSIGNED          DEFAULT NULL,
  `count_html`       INT(11)          UNSIGNED          DEFAULT NULL,
  `views_xml`        INT(11)          UNSIGNED          DEFAULT NULL,
  `views_html`       INT(11)          UNSIGNED          DEFAULT NULL,
